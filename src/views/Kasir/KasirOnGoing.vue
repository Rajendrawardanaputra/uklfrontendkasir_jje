                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            <a href="/kasirhome" class="nav-item nav-link">Home</a>
                            <a href="/kasirtransaksi" class="nav-item nav-link">transaksi</a>
                            <a href="/kasirongoing" class="nav-item nav-link active">On Going</a>
                            <a href="/kasirhistory" class="nav-item nav-link">History</a>
                            <!-- <a href="/menu" class="nav-item nav-link">Menu</a> -->
                            <a href="#" @click="logout" class="nav-item nav-link">LogOut</a>
                        </div>
                        <a href="" class="btn btn-primary py-2 px-4">Kasir</a>
                    </div>
                </nav>
                        ...
                        axios.put('http://localhost:8000/api/done_transaksi/' + this.detail_ongoing.id_meja, this.detail_ongoing.id_meja)
                            .then(
                                (response) => {
                                    ...
                                    setTimeout(() => {
                                        location.href = '/kasirprintstruk/' + this.detail_ongoing.id_pelayanan
                                    }, 1200);
                                }
                            )
                            .catch(
