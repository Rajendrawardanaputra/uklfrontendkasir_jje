        ...
        <div class="container-xxl bg-white p-0">
            ...
            <div class="container-xxl position-relative p-0">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                    <a href="/kasirhome" class="navbar-brand p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            ...
                            <a href="/kasirmenu" class="nav-item nav-link">Menu</a>
                            <!-- <a href="/menu" class="nav-item nav-link">Menu</a> -->
                            <a href="#" @click="logout" class="nav-item nav-link">LogOut</a>
                        </div>
                        <a href="/kasirhome" class="btn btn-primary py-2 px-4">Kasir</a>
                    </div>
                </nav>
                    ...
                    <div class="container my-5 py-5">
                        <div class="row align-items-center g-5">
                            <div class="col-lg-6 text-center text-lg-start">
                                <h1 class="display-3 text-white animated slideInLeft"> Afternoon Cafe</h1>
                                <p class="text-white animated slideInLeft mb-4 pb-2">Silahkan pesan</p>
