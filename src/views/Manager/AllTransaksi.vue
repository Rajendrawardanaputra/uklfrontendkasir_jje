        ...
        <div class="container-xxl bg-white p-0">
            ...
            <div class="container-xxl position-relative p-0">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                    <a href="/managerhome" class="navbar-brand p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            <a href="/managerhome" class="nav-item nav-link">Home</a>
                            <a href="/alltransaksi" class="nav-item nav-link active">All Transaksi</a>
                            <a href="/filtertransaksi" class="nav-item nav-link">Filter Transaksi</a>
                            <a href="/profit" class="nav-item nav-link">Profit</a>
                            <a href="#" @click="logout" class="nav-item nav-link">LogOut</a>
                        </div>
                        <a href="/managerhome" class="btn btn-primary py-2 px-4">Manager</a>
                    </div>
                </nav>
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h5 class="section-title ff-secondary text-center text-primary fw-normal">Transaksi History</h5>
                    </div>
